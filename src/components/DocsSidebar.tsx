...
const navigation: NavItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Track", href: "/docs/commands/track" },
      { title: "Stats", href: "/docs/commands/stats" },
      { title: "Config", href: "/docs/commands/config" },
      { title: "Export", href: "/docs/commands/export" },
      { title: "GitHub", href: "/docs/commands/github" },
      { title: "Logs", href: "/docs/commands/logs" },
      { title: "Secrets", href: "/docs/commands/secrets" },
      { title: "Sync", href: "/docs/commands/sync" },
      { title: "Timer", href: "/docs/commands/timer" },
      { title: "Focus", href: "/docs/commands/focus" },
      { title: "Breaks", href: "/docs/commands/breaks" },
      { title: "Notes", href: "/docs/commands/notes" },
      { title: "Project", href: "/docs/commands/project" },
      { title: "Habits", href: "/docs/commands/habits" },
      { title: "Dashboard", href: "/docs/commands/dashboard" },
      { title: "Report", href: "/docs/commands/report" },
      { title: "AI", href: "/docs/commands/ai" },
      { title: "Health", href: "/docs/commands/health" },
    ],
  },
  {
    title: "API Reference",
